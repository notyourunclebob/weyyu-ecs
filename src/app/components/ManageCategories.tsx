...
export default function ManageCategories({
  ...
  categories: { categories: CategoryBase[] };
}) {
        ...
        <div className="bg-black rounded-2xl p-8 min-h-[calc(100vh-130px)]">
          ...
          <div className="flex flex-col">
            ...
            <div className="bg-yutaniGrey rounded w-full">
              {categoryList
                .filter(
                  (category: CategoryBase) => category.allowChange === false,
                )
                .map((category: CategoryBase) => (
              ...
              {categoryList
                .filter(
                  (category: CategoryBase) => category.allowChange === true,
                )
                .map((category: CategoryBase) => (
            ...
            <div>
              <button
                ...
                className="px-12 py-3 mt-2 bg-gray-300 border-2 border-gray-300 text-black font-light rounded hover:bg-gray-400 transition"
              >
                Back
              </button>
            </div>
